...
ggplot(data = shg_trend) +
  geom_line(mapping = aes(x = year, y = avg_GDPcap, colour = regionISO, group = regionISO)) +
  theme_light() +
...
ggplot(data = shg_trend) +
  geom_line(mapping = aes(x = year, y = sum_IntHomicides, 
                          colour = regionISO, group = regionISO)) +
  theme_light() +
...
ggplot(data = shg_trend) +
  geom_line(mapping = aes(x = year, y = sum_SuicideMort, colour = regionISO, group = regionISO)) +
  theme_light() +
...
ggplot(data = shg_trend, mapping = aes(x = year)) +
  geom_line(mapping = aes(y = sum_IntHomicides), colour = "#33638DFF") +
  geom_line(mapping = aes(y = sum_SuicideMort), colour = "#29AF7FFF") +
  theme_light() +
